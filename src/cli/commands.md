...
::: danger Removed
The `win mfsu` command (including the `ls` / `build` / `remove` subcommands) was removed from WinJS in `0.19.1` along with the MFSU feature. Executing it will fail with an unknown command error.
:::
